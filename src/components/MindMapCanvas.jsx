  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-3 flex items-center justify-between shadow-sm">
        <div>
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Mind Map Canvas</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Organize ideas and strategies visually</p>
        </div>
